...
const PLANS = [
  {
    ...
    price: bnTaka(PLAN_PRICING.FREE.monthlyBdt),
    rooms: `সর্বোচ্চ ${bnNum(PLAN_PRICING.FREE.roomLimit)}টি Room`,
    staff: `${bnNum(PLAN_PRICING.FREE.staffLimit)} জন User`,
    features: ['Room ও Booking Management', 'Guest Profile ও Invoice', 'Direct Booking Page', 'সবসময় Full Data Export'],
    cta: 'Solo দিয়ে শুরু করুন',
  ...
  },
  {
    ...
    features: ['Solo-এর সব কিছু', 'Custom Domain ও Online Payment', 'Guest CRM ও Restaurant', 'Housekeeping, Inventory ও Maintenance', 'AI Content ও PDF Export'],
    cta: 'Independent Resort নিন',
  ...
  },
  {
    ...
    features: ['Independent Resort-এর সব কিছু', `সর্বোচ্চ ${bnNum(PLAN_PRICING.PROFESSIONAL.propertyLimit)}টি Property`, 'Channel Sync ও Corporate Accounts', 'Advanced Analytics ও AI Chatbot', 'Priority Support'],
    cta: 'Resort Group নিন',
